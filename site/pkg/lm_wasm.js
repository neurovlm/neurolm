/* @ts-self-types="./lm_wasm.d.ts" */

export class NeuroSession {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        NeuroSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_neurosession_free(ptr, 0);
    }
    /**
     * @param {string} config_json
     * @param {string} generation_json
     * @param {string} tokenizer_json
     * @param {string} meta_json
     */
    configure(config_json, generation_json, tokenizer_json, meta_json) {
        const ptr0 = passStringToWasm0(config_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(generation_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(tokenizer_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(meta_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.neurosession_configure(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[1]) {
    ...
    load_model(model_bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.neurosession_load_model(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    constructor() {
        const ret = wasm.neurosession_new();
        this.__wbg_ptr = ret >>> 0;
        NeuroSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) NeuroSession.prototype[Symbol.dispose] = NeuroSession.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lm_wasm_bg.js": import0,
    };
}

const NeuroSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_neurosession_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lm_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
